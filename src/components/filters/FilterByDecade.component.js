...
import './FilterByDecade.styles.css';
        ...
        <div className='col-md-12'>
          <div id='filter-decades' className='film-filter'>
            ...
            <div className='decades-filters'>
              <label htmlFor='oldest-decade' className='decades-filters__label'>
                From
              </label>
              ...
              <select
                name='decades'
                id='oldest-decade'
                defaultValue={oldestDecade}
                onChange={(e) => handleFilterByDecade(e)}
              >
                {decades.map((d, index) => {
                  return <Dropdown key={index} decade={d} />;
                })}
              </select>
              <label htmlFor='newest-decade' className='decades-filters__label'>
                To
              </label>
              <select
                name='decades'
                id='newest-decade'
                defaultValue={newestDecade}
                onChange={(e) => handleFilterByDecade(e)}
              >
                {decades.map((d, index) => {
                  return <Dropdown key={index} decade={d} />;
